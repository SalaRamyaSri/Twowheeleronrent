...
public class BookingDTO {
	...
	public BookingDTO(int advance, LocalDate fromdate, LocalDate todate, String message, int billamount, String cardno,
			String nameoncard, String userid, int varid) {
		super();
